...
save(svm_radial_tune, svm_radial_wflow, svm_radial_tictoc, file = "results/svm_radial_tune.rda")
...
# write out results & workflow
save(svm_radial_tune, svm_radial_wflow, svm_radial_tictoc, file = "results/svm_radial_tune_filter.rda")